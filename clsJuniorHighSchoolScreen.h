...
class clsJuniorHighSchoolScreen : protected clsScreen
{
...
private:
	...
	static void _ShowListStudentsScreen()
	{
		...
		clsListStudentScreen::ShowStudentListJuniorHighScreen();
	}

	static void _ShowAddNewStudentScreen()
	{
		//cout << "Add New student Screen well be here ";
		clsAddNewStudentScreen::ShowAddNewStudentJuniorHighScreen();
	...
	static void _ShowDeleteStudentScreen()
	{
		...
		clsDeleteStudentScreen::ShowDeleteStudentJuniorHighScreen();
	}

	static void _ShowUpdateStudentScreen()
	{
		//cout << "Update Screen well be here ";
		clsUpdateStudentScreen::ShowUpdateStudentJuniorHighScreen();
	}
	...
	static void _ShowAverageGradesScreen()
	{
		...
		clsAverageGradesScreen::ShowAverageJuniorHighGrades();
	}
