...
#include "clsManageTeachersScreen.h"

class clsKindergartenScreen : protected clsScreen
{
...
private:
	...
	static void _ShowListStudentsScreen()
	{
		...
		clsListStudentScreen::ShowStudentListKindergartenScreen();
	}

	static void _ShowAddNewStudentScreen()
	{
		//cout << "Add New student Screen well be here ";
		clsAddNewStudentScreen::ShowAddNewStudentKindergartenScreen();
