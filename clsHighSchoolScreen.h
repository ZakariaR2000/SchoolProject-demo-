...
class clsHighSchoolScreen : protected clsScreen
{
...
private:
	...
	static void _ShowListStudentsScreen()
	{
		...
		clsListStudentScreen::ShowStudentListHighScreen();
	}

	static void _ShowAddNewStudentScreen()
	{
		//cout << "Add New student Screen well be here ";
		clsAddNewStudentScreen::ShowAddNewStudentHighScreen();
